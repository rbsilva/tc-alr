...
$(function() {
        ...
        $( "#opener" )
            ...
            .click(function( event ) {
                ...
                $( "th", $modal_inbounds ).draggable({
                  helper: "clone",
                  cursor: "move"
                });

                $("th", $modal_facts).droppable({
                    accept: "#load_facts_modal #inbound table th",
        ...
        function loadFact( $item, $column ) {
          ...
          $table.find('td:nth-child('+$index+')').each( function(){
            ...
            $("#data_warehouse_load").append($hidden_data + 'id="load_data_' + $cont + '_' + $index_to +'" value="[' + $cont + ',' + $column.attr('id') + ',\'' + $content + '\']"></input>');
