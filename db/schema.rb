...
ActiveRecord::Schema.define(version: 20121022234620) do
  ...
  add_index "data_tables", ["user_id"], name: "index_data_tables_on_user_id", using: :btree
  ...
  add_index "fields", ["data_table_id"], name: "index_fields_on_data_table_id", using: :btree
  ...
  add_index "inbounds", ["raw_file_id"], name: "index_inbounds_on_raw_file_id", using: :btree
  ...
  add_index "raw_files", ["user_id"], name: "index_raw_files_on_user_id", using: :btree
